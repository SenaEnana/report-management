...
import { fetchMissedTerminalTransactionApi } from "@/services/MissedTransactionService";
...
export default function MissedTerminalDate() {
    ...
    const [loading, setLoading] = useState(false);
        ...
        const fetchData = async () => {
            setLoading(true);
            try {
                const response = await fetchMissedTerminalTransactionApi();
